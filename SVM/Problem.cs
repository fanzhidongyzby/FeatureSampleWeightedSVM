...
namespace SVM
{
	...
	{
        //记录训练样本顺序的相似度
        public static List<double> sampleSimilar = new List<double>();
        //记录属性的权值
        public static List<double> attrWeight = new List<double>();
        private int _count;
        private double[] _Y;
        private Node[][] _X;
        ...
        //public bool equal(Problem p)
        //{
        //    for (int i = 0; i < this.Count; i++)
        //    {
        //        for (int j = 0; j < this.X.Length; j++)
        //        {
        //            for (int k = 0; k < this.X[j].Length; k++)
        //            {
        //                if (this.X[j][k] != p.X[j][k])
        //                    return false;
        //            }
        //        }
        //    }
